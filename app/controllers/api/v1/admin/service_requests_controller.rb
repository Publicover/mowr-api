...
class Api::V1::Admin::ServiceRequestsController < ApplicationController
  ...
  def index
    ...
    serialized_response(@service_requests)
  end
  ...
  def create
    ...
    serialized_response(@service_request) if @service_request.save
  end
