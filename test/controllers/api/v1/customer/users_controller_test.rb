...
class Api::V1::Customer::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should not get index as customer' do
    get api_v1_customer_users_path, headers: @authorized_headers
    assert_match json['message'], Message.unauthorized
  end

  test 'should show own record as customer' do
    get api_v1_customer_user_path(@user), headers: @authorized_headers
    assert_response :success
  end

  test 'should update own record as customer' do
    patch api_v1_customer_user_path(@user), params: { user: { f_name: 'New Name McGee' } }.to_json, headers: @authorized_headers
    assert_response :success
  ...
  test 'should delete own record as customer' do
    ...
    delete api_v1_customer_user_path(@user), headers: @authorized_headers
