...
class Api::V1::Customer::SizeEstimatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should not get index as customer' do
    get api_v1_customer_size_estimates_path, headers: @authorized_headers
    assert_match json['message'], Message.unauthorized
  end

  test 'should get own size estimate as customer' do
    get api_v1_customer_size_estimate_path(@size_estimate), headers: @authorized_headers
  ...
  test 'should destroy own size estimate as customer' do
    ...
    delete api_v1_customer_size_estimate_path(@size_estimate), headers: @authorized_headers
    assert_response :success
