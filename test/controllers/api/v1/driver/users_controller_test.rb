...
class Api::V1::Driver::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should delete own record as driver' do
    ...
    delete api_v1_driver_user_path(@user), headers: @authorized_headers
