...
class BaseLocationTest < ActiveSupport::TestCase
  test 'should validate line1' do
    ...
    assert_not_nil base.errors[:line1]
  end

  test 'should validate city' do
    base = BaseLocation.new(line1: '123 Test St', state: 'NC', zip: '19824')
    assert_not base.save
    assert_not_nil base.errors[:city]
  end

  test 'should validate state' do
    base = BaseLocation.new(line1: '123 Test St', city: 'Testington', zip: '19824')
    assert_not base.save
    assert_not_nil base.errors[:state]
  end

  test 'should validate zip' do
    base = BaseLocation.new(line1: '123 Test St', city: 'Testington', state: 'NC')
    assert_not base.save
  ...
  test 'should geocode after_validation' do
    VCR.use_cassette('home base unit create') do
      BaseLocation.create!(name: 'Plowr HQ', line1: '2828 W 13th St',
